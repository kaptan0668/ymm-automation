    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-ink/60">
          Genel durum, hızlı metrikler ve görevler.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-sm text-ink/50">Son 30 gün +12</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Badge>Yıl 2026</Badge>
            </div>
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-semibold">876</div>
            <div className="text-sm text-ink/50">Bugün 8 adet</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
